# GitHub Copilot Instructions for Vue Demo Site

This is a demo site for **Duff Cloud Services (DCS)** CMS integration. It showcases the Vue 3 framework with runtime content management.

## Project Overview

- **Framework**: Vue 3
- **CMS Package**: `@duffcloudservices/cms`
- **Site Slug**: `demo-2`
- **Purpose**: Demonstration of DCS CMS content editing capabilities

## Technology Stack

- Vue 3.5+ with Composition API and Vue Router
